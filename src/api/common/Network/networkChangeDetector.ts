...
@singleton()
export class NetworkChangeDetector implements INetworkChangeDetector {
  public isInitialized: boolean = false
  private readonly _name: string = 'NetworkChangeDetector'
  private _logger: ILogService<any>
  private cfg!: NetworkChangeDetectorConfig & typeof DEFAULT_CFG
  private electronCfg!: ElectronIntegrationConfig & typeof DEFAULT_ELECTRON_CFG
  ...
  private prepareUrlList(): string[] {
    return this.cfg.checkUrls && this.cfg.checkUrls.length > 0
      ? [...this.cfg.checkUrls]
      : this.cfg.primaryUrl
        ? [this.cfg.primaryUrl]
        : []
